    ...
    public static void main(String[] args) {
        ...
        while (!EOF) {
            ...
            try {
                ...
                System.out.println("Failed to Insert Lineno "+LineNumber+" Into the Table. Skipping..." + ex);
            }
        ...
        System.out.println("LETS FUCKING GOOOOOOOOOOOOOOOOOO");
    ...
    private static ToolArguments ParseArguments(String[] args) {
        ...
        for (String arg : args) {
            if (arg.contains("--csvpath=")) {
                ...
                arguments.dbName = Arrays.stream(arg.split("--dbname=")).toList().getLast();
            else if (arg.contains("--dbuser="))
                arguments.dbUsername = Arrays.stream(arg.split("--dbuser=")).toList().getLast();
            else if (arg.contains("--dbpass="))
                arguments.dbPassword = Arrays.stream(arg.split("--dbpass=")).toList().getLast();
